...
<div
  ...
  style={{ paddingTop: "30px", paddingBottom: "0px", position: "relative", overflow: "hidden" }}
>
  <div className="container">
    <SectionTitle
      title="Anthem Infotech – Smart Custom Software & AI Solutions Built to Grow Your Business."
    ...
    <div className="row">
      <div className="col-xl-7 col-lg-6 col-12">
        <div className="about-image-area" style={{ position: "relative", overflow: "hidden", maxHeight: "500px" }}>

          <div className="about-image" style={{ overflow: "hidden" }}>
            <Tilt scale={scale} transitionSpeed={4000} style={{ display: "block", maxHeight: "350px" }}>
              <img src={aboutImage1} alt="home_agency_about" loading="lazy" />
            </Tilt>
          </div>
          ...
          >
            <span data-depth="1">
              <img src={aboutShape} alt="about-shape" loading="lazy" style={{ width: "250px", height: "auto" }} />
            </span>
          </div> */}
      ...
      <div className="col-xl-5 col-lg-6 col-12">
        <div className="about-content-area">
          <SectionTitleTwo title="We streamline and automate core business processes." />
