    ...
    return (
        <div className="blog-3 col">
            <div className="thumbnail">
                <Link to={process.env.PUBLIC_URL + `/blog-details/${data.id}`} className="image"><img src={`${process.env.process.env.REACT_APP_PUBLIC_URL}/${data.largeImage}`} alt="Blog Image" loading="lazy" /></Link>
            </div>
            <div className="info">
                <ul className="meta">
